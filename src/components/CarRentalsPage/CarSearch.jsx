            ...
            <div className="carRentals}>
                <div className="box1}>
                    ...
                    <div className="box2}>
                        <div className="searchInputBox}>
                            ...
                            {show === "true" ? null : <div className="drop}>
                                <IconButton sx={{ p: '10px' }} aria-label="menu">
                                    <DirectionsCarOutlinedIcon />
                                </IconButton>
                                <SearchBar2
                        ...
                        <button className="searchButton} onClick={handleClickSearch}>
                            <Link to="/car-available" className="searchLink}>SEARCH</Link>
                        </button>
                    </div>
                ...
                <div className="box3}>
                    ...
                    <div className="box4}>
                        {
                            carRental?.map((item) => {
                                return <button key={item.id} className="card1}>
                                    <Link to={`/carrentals/${item.city}`} className="link}>
