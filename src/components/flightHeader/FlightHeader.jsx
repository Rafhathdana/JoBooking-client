    ...
    <>
      <div className="head">
        <div className="flightformcont">
          <div className="flightformoutmost">
            <div className="flightformbox">
              <div className="flightform">
                <div className="flightformfilter">
                  <div className="flightformradio">
                ...
                <div className="yellowBox">
                  <div>
                    ...
                    <div className="DateInputGroup" aria-label="When?">
                      <div>
                        <div style={{ width: "100%" }}>
                          <span className="span">
                            <div role="button" tabindex="0">
                    ...
                    <button className="search">
                      <Link className="btnLink" to={`/flights/${startDate}`}>
                        Search
                      </Link>
                    </button>
                  </div>
